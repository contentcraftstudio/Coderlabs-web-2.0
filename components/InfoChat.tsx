          ...
          <div className='col-span-1 divide-y-2 divide-white lg:max-w-[900px] xl:w-[900px] md:max-w-[650px] lg:p-[70px] sm:p-[30px] lg:mt-[320px] md:mt-[170px] sm:mt-[90px] lg:ml-[100px] '>
            <div>
              <Image
                src={coderlabsLogo}
                alt='coderlabs logo'
                className='sm:w-[35px] sm:h-[32px] md:w-[45px] md:h-[40px] xl:w-[52px] xl:h-[48px] xl:mt-[-385px] xl:mb-[345px] sm:mt-[-115px] sm:mb-[145px] md:mt-[-195px] md:mb-[185px]'
              />
              <Image
                ...
                height={70}
              />
              <h1 className='titlehero font-secondary text-white font-normal sm:text-[32px] md:text-[46px] xl:text-[58px] lg:leading-[90px] sm:ml-[5px] mb-[40px]'>
                Lorem ipsum dolor sit amet
              </h1>
            </div>
            <div className='space-y-8 sm:pt-[20px] md:pt-[40px] xl:pt-[60px] mb-[30px]'>
              <p className='font-primary font-light text-white md:w-[600px] sm:text-[16px] md:text-[20px] sm:leading-[19px] md:leading-[23px]'>

            ...
            <div className='member__holder'>
              ...
              <div className='grid grid-cols-2 items-end'>
                <div className='member__data'>
                  ...
                  <div className='flex  sm:flex-col sm:h-[90px] md:flex-row sm:p-[16px] lg:h-[28px] justify-between items-center sm:gap-0 md:gap-8 lg:w-fit border-[1px] border-[#444] leading-none rounded-[8px] py-[7px] lg:px-[10px] lg:divide-x divide-solid'>
                    ...
                    <span className='text-right md:pl-8  flex items-center  gap-2'>
                      ...
                      <span className='sm:text-[12px] lg:text-[16px] sm:mt-1'>@{team.name}</span>
                    </span>
                  </div>
                </div>

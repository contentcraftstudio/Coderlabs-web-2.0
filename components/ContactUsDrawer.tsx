          ...
          <article className="relative w-screen max-w-lg pb-10 flex flex-col gap-4 h-full space-y-6 p-6">
            ...
            <ul className="flex flex-col gap-4 text-xs font-medium">
              <li className="flex gap-3 px-2">
                <Image src={atIcon} alt="Mail" />
                contact@coderlabs.co
              </li>
              <li className="flex gap-3 px-2">
                <Image src={phoneIcon} alt="Mail" />
                300 277 1564
              </li>
              <li className="flex items-start gap-3 px-2">
                <Image src={locationIcon} alt="Mail" />
                Calle 35A No. 17-74, piso 3, Barranquilla, Atlantico, Colombia,
                080006.
              </li>
              <li className="flex items-start gap-3 px-2">
                <Image src={clockIcon} alt="Mail" />
                Lunes - viernes 9:00 a 18:00 Confirmar antes de llegar.
              </li>
            </ul>

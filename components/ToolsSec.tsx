...
export default function ToolsSec({}: Props) {
  ...
  return (
    <section className=' grid sm:grid-cols-1 xl:grid-cols-2 gap-2 py-[32px]'>
      <div className=' sm:pb-[50px] md:pb-[30px] sm:text-center xl:text-start xl:divide-y-2 divide-gray-800 px-4'>
        <h3 className=' font-secondary font-medium sm:text-[34px] lg:text-[48px] sm:pb-4 xl:pb-[40px] '>{t('Tools_and_technologies')}</h3>

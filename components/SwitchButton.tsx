  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div
        ...
        after:border-white ${translate} after:absolute sm:after:top-[2.5px] md:after:top-[3.5px] lg:after:top-[6px]
        after:bg-white after:border-grewn after:border after:rounded-[80px] sm:after:text-[11px] md:after:text-[12px] 
        ${textColor} sm:after:h-[25px] md:after:h-[28px] sm:after:w-[25px] md:after:w-[28px] sm:after:p-[4px] md:after:p-[4px] 

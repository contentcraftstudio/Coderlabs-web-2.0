    ...
    <div className='sm:columns-1 lg:columns-2 p-[24px] lg:px-[110px] sm:pt-[70px] md:pt-[104px] lg:pt-[167px]'>
      <div className='flex flex-col  items-start xl:min-h-[600px] py-3 sm:pb-[100px]'>
        ...
        <div className=' space-y-4'>
          <p className='font-normal font-primary sm:text-[16px] sm:w-[330px] md:w-[624px] xl:w-[497px] lg:text-[20px] text-white sm:leading-[19px] lg:leading-[23px]'>{t('paragraph_our_blog_1')}</p>
          <p className='font-normal font-primary sm:text-[16px] sm:w-[330px] md:w-[624px] xl:w-[497px] lg:text-[20px] text-white sm:leading-[19px] lg:leading-[23px]'>{t('paragraph_our_blog_2')}</p>
          <p className='font-normal font-primary sm:text-[16px] sm:w-[330px] md:w-[624px] xl:w-[497px] lg:text-[20px] text-white sm:leading-[19px] lg:leading-[23px]'>{t('paragraph_our_blog_3')}</p>
        </div>

...
export default function Cards() {
  ...
  return (
    <div className="sm:px-[30px] lg:px-0">
      <div id="services" className="sm:pb-[0px] md:pb-[80px] lg:pb-[113px]">
        ...
        <p className="font-primary font-normal text-center sm:text-[16px] md:text-[20px] sm:w-auto md:w-[630px] lg:w-[730px] sm:mb-[48px] xl:mb-[-20px] mx-auto sm:leading-[19px] md:leading-[23px]">
          {t("paragraph_focus")}
        </p>
      </div>

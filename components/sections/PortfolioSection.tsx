...
export default function PortfolioSection() {
  ...
  // Aunque no se usa directamente, se mantiene para posibles traducciones futuras

  return (
    <section
      id="portfolio"
      className="w-[100%] sm:px-[30px] md:px-[60px] lg:px-[103px] 2xl:px-[60px] sm:mt-[80px] md:mt-[100px] lg:mt-[140px]"
    >
      <div className="flex flex-col md:flex-row justify-between items-start mb-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-gray-600 sm:text-[16px] md:text-[18px] font-primary max-w-xl">
            Explore nuestro portafolio de soluciones digitales innovadoras, que
            muestran nuestra creatividad y experiencia en la entrega de

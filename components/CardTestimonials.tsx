...
export default function CardTestimonials ({
  ...
  return (
    <div className='flex items-center sm:mx-h-auto md:h-[277px] lg:h-[318px] sm:w-auto md:w-[573px] lg:w-[573px] sm:px-[30px] md:px-[70px] lg:px-[66px] border-2 rounded border-white'>

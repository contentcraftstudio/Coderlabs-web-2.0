    ...
    try {
      const response = await axios({
        ...
        headers: {
          ...
          Authorization:
            "Bearer CFPAT-fKiWMmszBuloITj0wuE2LZH2c46tGaLtswEXsJulQFU",
    ...
    <div className="w-[100%] sm:px-[30px] md:px-[60px] xl:px-[103px] 2xl:px-[60px]">
      ...
      >
        <>
          <div
            id="form__coderlabs"
            className="w-full bg-white rounded sm:px-[15px] md:px-[40px] py-[20px] sm:py-[20px] sm:space-y-[20px] md:space-y-[40px] text-sm"
          >
            ...
            <FormInput label={t("Your_budget")} name="message" type="message" />
            <ErrorMessage name="message" />
            {formularioEnviado === true ? (
              <p>{t("Contact_Form_successful")}</p>
            ) : null}
